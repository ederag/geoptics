# -*- coding: utf-8 -*-
#
# geoptics documentation build configuration file, created by
# sphinx-quickstart on Tue Dec 23 19:53:21 2014.
#
...
try:
    release = pkg_resources.get_distribution('geoptics').version
    print("v{} from distribution".format(release))
except pkg_resources.DistributionNotFound:
	from geoptics import __version__ as release
	print("distribution not found: direct import yields v{}".format(release))
del pkg_resources
...
rst_epilog = """
.. |geoptics| replace:: :program:`GeOptics`
"""
...
man_pages = [
    ('index', 'geoptics', u'geoptics Documentation',
     [u'Ederag'], 1)
]
...
texinfo_documents = [
  ('index', 'geoptics', u'geoptics Documentation',
   u'Ederag', 'geoptics', 'One line description of project.',
   'Miscellaneous'),
]
...
intersphinx_mapping = {
	...
	# Right now this is useless. FIXME: to investigate
